...
export function PreviewBadge() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-[100] flex justify-center px-3 pb-3 pointer-events-none">
      <div className="pointer-events-auto flex items-center gap-2.5 rounded-full border border-amber-500/30 bg-amber-500/15 px-4 py-2 text-xs font-medium text-amber-700 shadow-lg backdrop-blur-md dark:text-amber-300">
        ...
        <button
          ...
          className="ms-1 rounded-full p-0.5 hover:bg-amber-500/20"
        >
